    ...
    <div className="min-h-screen bg-[#f5f0eb] dark:bg-[#111111] text-[#1a1a1a] dark:text-[#f0f0f0]">
      ...
      <section className="relative w-full overflow-hidden">
        ...
        <div className="relative z-10 pt-28 pb-16 md:pt-32 md:pb-20 lg:pt-36 lg:pb-24 flex flex-col items-center justify-center text-center px-6">
          <ScrollAnimate variant="fadeUp" className="max-w-4xl mx-auto space-y-6">
        ...
        <ScrollAnimate variant="fadeRight" className="relative aspect-square w-full rounded-3xl overflow-hidden bg-neutral-200 dark:bg-[#1a1a1a] group">
          <Image 
        ...
        <ScrollAnimate variant="fadeLeft" className="space-y-8">
      ...
      <section className="bg-white dark:bg-[#151515] py-24 lg:py-32 rounded-t-[3rem] lg:rounded-t-[5rem]">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          <ScrollAnimate variant="fadeUp" className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          ...
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12" staggerDelay={0.1}>
            {[
              {
                icon: Sparkles,
                title: "Quality First",
              ...
              <StaggerItem key={idx} variant="scaleUp" className="flex flex-col items-center text-center sm:items-start sm:text-left space-y-4 sm:space-y-5 group">
