      ...
      <div className="relative z-10 w-full max-w-sm py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div className="grid grid-cols-1 gap-5">
            {/* Name */}
            <div>
              <label className="block text-[10px] font-semibold tracking-wider uppercase text-[#1a1a1a] dark:text-[#e0e0e0] mb-2" htmlFor="name">
                Full Name
              </label>
              <input
                id="name"
                ...
                className={`flex h-11 w-full border-b ${errors.name ? 'border-red-500' : 'border-[#1a1a1a]/20 dark:border-white/20 focus:border-[#1a1a1a] dark:focus:border-white'} bg-transparent px-2 py-2 text-sm text-[#1a1a1a] dark:text-white placeholder:text-neutral-400 focus:outline-none transition-colors`}
                placeholder="John Doe"
              />
              {errors.name && <p className="mt-2 flex items-center gap-1 text-[10px] uppercase tracking-wide text-red-500"><AlertCircle className="w-3 h-3" /> {errors.name}</p>}
            </div>
          ...
          {/* Profile Picture URL */}
          <div>
            <label className="block text-[10px] font-semibold tracking-wider uppercase text-[#1a1a1a] dark:text-[#e0e0e0] mb-2" htmlFor="profilePictureUrl">
            ...
            <input
              ...
              onChange={handleChange}
              className={`flex h-11 w-full border-b ${errors.profilePictureUrl ? 'border-red-500' : 'border-[#1a1a1a]/20 dark:border-white/20 focus:border-[#1a1a1a] dark:focus:border-white'} bg-transparent px-2 py-2 text-sm text-[#1a1a1a] dark:text-white placeholder:text-neutral-400 focus:outline-none transition-colors`}
              placeholder="https://example.com/avatar.jpg"
            />
            {errors.profilePictureUrl && <p className="mt-2 flex items-center gap-1 text-[10px] uppercase tracking-wide text-red-500"><AlertCircle className="w-3 h-3" /> {errors.profilePictureUrl}</p>}
          </div>

          {/* Password */}
          <div>
            <label className="block text-[10px] font-semibold tracking-wider uppercase text-[#1a1a1a] dark:text-[#e0e0e0] mb-2" htmlFor="password">
              Password
            </label>
            ...
            {errors.password ? (
              ...
              <p className="mt-2 text-[9px] uppercase tracking-wider text-neutral-500">
          ...
          <button
            ...
            className="w-full mt-8 flex items-center justify-center h-11 bg-[#1a1a1a] dark:bg-[#f0f0f0] text-white dark:text-[#111111] text-[11px] font-semibold tracking-[0.15em] uppercase hover:bg-[#333] dark:hover:bg-[#ddd] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {isSubmitting ? (
        ...
        <p className="text-center text-[10px] tracking-wider uppercase text-neutral-500 pt-8">
          ...
          <Link href="/login" className="font-bold text-[#1a1a1a] dark:text-white hover:opacity-70 transition-opacity">
            Log In
          </Link>
        </p>
      </div>
