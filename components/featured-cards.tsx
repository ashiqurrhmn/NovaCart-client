...
export function FeaturedCards() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Animate each card with unique entrance
      cardsRef.current.forEach((card, i) => {
        ...
        // Magnetic hover effect on card images
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full bg-[#f5f0eb] dark:bg-[#111111] py-4 pb-16 mt-16 transition-colors"
    >
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div
            ref={setCardRef(0)}
            className="lg:col-span-1 h-[450px] relative rounded-2xl bg-[#f4f4f4] overflow-hidden group"
          ...
          >
            <Image
              ...
              fill
              className="object-cover object-top grayscale transition-transform duration-700"
            />
