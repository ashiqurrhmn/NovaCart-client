  ...
  return (
    <section className="relative w-full h-[calc(100vh-56px)] min-h-[480px] max-h-[550px] sm:max-h-[720px] overflow-hidden bg-[#f5f0eb] dark:bg-[#111111] flex items-end">
      ...
      <div className="relative z-[3] w-full max-w-[1440px] mx-auto px-6 lg:px-10 pb-6 sm:pb-12 h-full flex flex-col justify-between pointer-events-none">
        {/* Top section: tagline */}
        <div className="pt-6 sm:pt-10 pointer-events-auto">
        ...
        <div className="flex items-end justify-between">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pointer-events-auto w-full sm:w-auto">
            <Link
              href="/shop"
